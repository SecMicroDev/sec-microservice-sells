...
from app.models.enterprise import Enterprise #, EnterpriseWithHierarchy
...
class UpdateEvent:
    ...
    def _check_valid_user_event(self):
        ...
        if self.event in (user_events + enterprise_events):
            ...
            print(f"Checking valid event scope: {any((self.event_scope == DefaultScope.SELLS.value, check_update_scope == DefaultScope.SELLS.value,))}")
            return any((
    ...
    async def update_table(self):
        ...
        # elif self.event == EnterpriseEvents.ENTERPRISE_CREATED:
        ...
        #     print("Received UpdateEnterprise event")
